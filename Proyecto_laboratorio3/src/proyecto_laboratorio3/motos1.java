 ...
 * @author ASUS
 */
public class motos1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(motos1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
